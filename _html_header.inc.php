...
<head>
<?php
if( in_array($disp,$Skin->arc_disp_arr) && $MainList->total_pages > 0 && $paged > $MainList->total_pages )		{
		echo '</head>';
...
add_headline( '<![endif]-->' ); ?>
	...
	$Skin->eo_remove_headline('js','jquery.min');?>
        <script type="text/javascript" src="<?php echo $skinuri; ?>js/jquery.min.js"></script>
